...
#define STATIC_ASSERT_NAME_(line) _static_assert_##line
#define STATIC_ASSERT_NAME(line) STATIC_ASSERT_NAME_(line)
#define STATIC_ASSERT(cond, message) char STATIC_ASSERT_NAME(__LINE__)[(cond) ? 1 : -1]
